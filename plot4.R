...
par(mfcol = c(2,2))
with(sub_df, plot(DateTime, Global_active_power, type="l", xlab = "", ylab="Global Active Power (kilowatts)"))
...
with(sub_df, plot(DateTime, Voltage, type="l", xlab = "datetime", ylab="Voltage"))
with(sub_df, plot(DateTime, Global_reactive_power, type="l", xlab = "datetime", ylab="Global_reactive_power"))
dev.off()